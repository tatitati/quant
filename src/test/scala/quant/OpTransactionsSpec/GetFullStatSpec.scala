...
class GetFullStatSpec extends FunSuite {
  ...
  test("Can update full stat as transactions are comming"){
    ...
    val accStats2 = OpTransactions.getFullStat(
      Transaction("tr0","accA",2,"BB",20000), accStats1
    )

    val accStats3 = OpTransactions.getFullStat(
      Transaction("tr0","accA",3,"BB",20000), accStats2
    )

   assert(
     List(Stat3(1,"accA",0.0,0.0,1,Map("BB" -> 0.0, "AA" -> 0.0, "FF" -> 0.0, "GG" -> 0.0, "EE" -> 0.0, "CC" -> 0.0, "DD" -> 0.0)))
       == accStats1)


   assert(
     List(
       Stat3(1,"accA",0.0,0.0,1,Map("AA" -> 0.0, "BB" -> 0.0, "CC" -> 0.0, "DD" -> 0.0, "EE" -> 0.0, "FF" -> 0.0, "GG" -> 0.0)),
       Stat3(2,"accA",0.0,0.0,1,Map("AA" -> 0.0, "BB" -> 0.0, "CC" -> 0.0, "DD" -> 0.0, "EE" -> 0.0, "FF" -> 0.0, "GG" -> 0.0))
     ) == accStats2)
//
//   assert(List(
//     Stat3(
